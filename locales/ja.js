...
I18n.register('ja', {
  ...
  'landing.tab.draw': '描画',
  'draw.title': '描画',
  'settings.drawTheme.default': 'クリーンキャンバス',
  'settings.drawTheme.neon': 'ネオングロー',
  'settings.drawTheme.chalk': 'チョークボード',
  'settings.drawTheme.glow-stick': 'ライトペインティング',
  'settings.drawTheme.watercolor': '水彩画',
  'settings.drawTheme.spray': 'スプレーペイント',
  'settings.drawTheme.pixel': 'ピクセルアート',
  'settings.drawTheme.calligraphy': '書道',
  'settings.drawTheme.crayon': 'クレヨン',
  'settings.drawTheme.sparkle': 'スパークルトレイル',
  'settings.drawTheme.led': 'LEDマトリクス',
  'settings.drawTheme.laser': 'レーザー',
  'settings.drawThemeLabel': 'テーマ',
  'settings.section.drawThemeParams': 'テーマオプション',
  'landing.draw.preset.default': 'スムーズな線のクリーンなキャンバス。',
  'landing.draw.preset.neon': 'ダーク背景にネオンの輝き。',
  'landing.draw.preset.chalk': '黒板にチョークの質感。',
  'landing.draw.preset.glow-stick': '光る軌跡のライトペインティング。',
  'landing.draw.preset.watercolor': '水彩のにじみ効果。',
  'landing.draw.preset.spray': 'コンクリートにスプレーペイント。',
  'landing.draw.preset.pixel': 'グリッド上のレトロピクセルアート。',
  'landing.draw.preset.calligraphy': '速度で太さが変わる筆文字。',
  'landing.draw.preset.crayon': '紙にワックスクレヨンの質感。',
  'landing.draw.preset.sparkle': 'キラキラ輝くパーティクルトレイル。',
  'landing.draw.preset.led': 'LEDドットマトリクスディスプレイ。',
  'landing.draw.preset.laser': '金属表面へのレーザー彫刻効果。',
  'landing.builder.card.drawTheme': 'テーマ',
  'settings.param.size': 'サイズ',
  'settings.param.opacity': '不透明度',
  'settings.param.smooth': 'スムージング',
  'settings.param.eraser': '消しゴム',
  'settings.param.trail': 'トレイル',
  'settings.param.fade': 'フェード',
  'settings.param.spread': '拡散',
  'settings.param.scatter': '散乱',
  'settings.param.pressure': '筆圧',
  'settings.param.twinkle': 'きらめき',
  'settings.param.texture': 'テクスチャ',
  'settings.param.wax': 'ワックス',
  'settings.param.ledSize': 'LEDサイズ',
  'settings.param.power': 'パワー',
  'settings.param.engrave': '彫刻',
  'toolbar.undo': '元に戻す',
  'toolbar.clear': 'クリア',
  'toolbar.lock': 'キャンバスをロック',
  'toolbar.unlock': 'キャンバスのロック解除',
