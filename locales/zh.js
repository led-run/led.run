...
I18n.register('zh', {
  ...
  'landing.tab.draw': '画板',
  'draw.title': '画板',
  'settings.drawTheme.default': '简洁画布',
  'settings.drawTheme.neon': '霓虹发光',
  'settings.drawTheme.chalk': '黑板粉笔',
  'settings.drawTheme.glow-stick': '光绘效果',
  'settings.drawTheme.watercolor': '水彩画',
  'settings.drawTheme.spray': '喷漆效果',
  'settings.drawTheme.pixel': '像素画',
  'settings.drawTheme.calligraphy': '书法',
  'settings.drawTheme.crayon': '蜡笔画',
  'settings.drawTheme.sparkle': '闪光拖尾',
  'settings.drawTheme.led': 'LED 点阵',
  'settings.drawTheme.laser': '激光',
  'settings.drawThemeLabel': '主题',
  'settings.section.drawThemeParams': '主题选项',
  'landing.draw.preset.default': '白色画布，平滑流畅的笔触。',
  'landing.draw.preset.neon': '深色背景上的霓虹发光效果。',
  'landing.draw.preset.chalk': '黑板上的粗糙粉笔质感。',
  'landing.draw.preset.glow-stick': '荧光棒长曝光光绘效果。',
  'landing.draw.preset.watercolor': '水彩扩散晕染笔触。',
  'landing.draw.preset.spray': '混凝土纹理上的喷漆效果。',
  'landing.draw.preset.pixel': '网格画布上的复古像素画。',
  'landing.draw.preset.calligraphy': '速度感应的毛笔书法效果。',
  'landing.draw.preset.crayon': '纸张上的蜡笔纹理。',
  'landing.draw.preset.sparkle': '闪闪发光的粒子拖尾。',
  'landing.draw.preset.led': 'LED 点阵显示屏，发光圆点效果。',
  'landing.draw.preset.laser': '金属拉丝表面上的激光雕刻效果。',
  'landing.builder.card.drawTheme': '主题',
  'settings.param.size': '大小',
  'settings.param.opacity': '不透明度',
  'settings.param.smooth': '平滑度',
  'settings.param.eraser': '橡皮擦',
  'settings.param.trail': '拖尾',
  'settings.param.fade': '渐隐',
  'settings.param.spread': '扩散',
  'settings.param.scatter': '散射',
  'settings.param.pressure': '压感',
  'settings.param.twinkle': '闪烁',
  'settings.param.texture': '纹理',
  'settings.param.wax': '蜡质',
  'settings.param.ledSize': 'LED 尺寸',
  'settings.param.power': '功率',
  'settings.param.engrave': '雕刻',
  'toolbar.undo': '撤销',
  'toolbar.clear': '清空',
  'toolbar.lock': '锁定画布',
  'toolbar.unlock': '解锁画布',
